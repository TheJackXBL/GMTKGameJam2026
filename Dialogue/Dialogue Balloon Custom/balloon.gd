...
func _ready() -> void:
	...
	#dialogue_label.spoke.connect(_on_character_spoken)
...
func set_voice(character:String):
	match character:
		"Kid":
			voicebox.base_pitch = 3.2
		
		"Mom":
			voicebox.base_pitch = 2.6
		
		"Grandma":
			voicebox.base_pitch = 2.0
...
func apply_dialogue_line() -> void:
	...
	set_voice(dialogue_line.character)
	...
	voicebox.stop()
	voicebox.play_string(dialogue_line.text)
	voicebox.play_string(dialogue_line.text)
...
#func _on_character_spoken(letter: String) -> void:
	#if letter.strip_edges().is_empty():
		#return
	#
	#voicebox.play_string(letter)
